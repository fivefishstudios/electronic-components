...
MODEL_NAME = "electronic_componentsV2-9542-9271.pth"  # train_acc, test_acc
MODEL_PATH_NAME = MODEL_PATH / MODEL_NAME

BATCH_SIZE = 5
NODES = 64

class_names = ['IC_chip', 'TO-3_transistor', 'TO-92_transistor', 'ceramic_capacitor', 'electrolytic_capacitor',
               'metal_film_resistor', 'relay']
...
# filepathname = "./unknown/ceramic3.jpg"     # resistor
# filepathname = "./unknown/electrolytics1.jpg"
# filepathname = "./unknown/electro2.jpg"     # ceramic caps
# filepathname = "./unknown/electro3.jpg"
# filepathname = "./unknown/chip1.jpg"
# filepathname = "./unknown/chip3.jpg"    # relay
filepathname = "./unknown/chip4.jpg"
# filepathname = "./unknown/chip5.jpg"    # relay
filepathname = "./unknown/chip6.jpg"    # relay
...
with torch.inference_mode():
    ...
    cv2.putText(unknown_img, class_names[torch.argmax(predicted_class_logits)], (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1.2,
                (0, 0, 255), 3)
